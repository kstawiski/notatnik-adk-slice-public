...
- Public Cloud Run: revision `notatnik-adk-slice-00007-gxm` deployed in `europe-west1` with maxScale=2/minScale=0; live `/health`, `/cases`, Chrome first-screen/mobile visual checks, and Chrome `CASE-003` UI run smoke green.
